...
| CloudNativePG (CNPG) | PostgreSQL Database (Operator with 1 Shared Cluster) for any K8s app (https://medium.com/@surbhi19/we-put-our-production-database-on-kubernetes-heres-what-dbre-taught-us-c0875f3acfc3) |  :mag: dev-mode |  ⭐ |
